<template>
      <div id="app">
        ...
        <!------ 1. Component dan Template Header ------>
        <app-header
            :user="user"
        ...
        <main>
            ...
            <section v-show="currentTab === 'home'">
                <div class="banner">
                    <div class="banner-content">
                        ...
                        <h3 class="subtitle">Sistem Informasi Pemesanan dan Distribusi Bahan Ajar Universitas Terbuka</h3>
            ...
            <!------ 2. Component dan Template stock-table (tabel stok buku)---->
            ...
            <!------ 3. Component dan Template do-tracking (tabel tracking DO)------>
        ...
        <!------ 4. Component dan Template stock-form (tambah/edit buku baru)------>
        <stock-form
            :is-open="isModalOpen"
            :mode="modeModal"
        ...
        <!------ 5. Component dan Template do-form (tambah do pengiriman baru)------>
        <do-form
        ...
        <!------ 6. Component dan Template login-modal (form login user)------>
        <login-modal
        ...
        <!------ 7. Component dan Template footer ------>
...
export default {
    ...
    data: {
        ...
        modalTitle: '',
        modeModal: 'tambah',
        bukuForm: { kode: '', judul: '', kategori: '', upbjj: '', harga: 0, qty: 0, safety: 10, cover: '/assets/img/std_buku.jpg' },
    ...
    methods: {
        ...
        // --- 2. LOAD DATA DARI API SERVER MYSQL https://api.geprekndut.my.id/api.php ---
        ambilDataOnline() {
            var vm = this;
            vm.isLoading = true;
            vm.error = null;
            ...
            apiService.getOnlineData()
                .then(function (response) {
                    ...
                    // Update Stok dari Database
                    if (apiData.stok) {
                        vm.state.stok = apiData.stok;
                   }

                    // Update User dari Database (hanya ambil data user, belum termasuk verifikasi login)
                    if (apiData.users) {
        ...
        handleLogin(credentials) {
            ...
            if (!this.state.dataPengguna || this.state.dataPengguna.length === 0) {
                 alert("Data pengguna sedang dimuat, coba sesaat lagi."); return;
            }

            const foundUser = this.state.dataPengguna.find(u =>
        ...
        handleBukaModalTambah() {
            ...
            this.bukuForm = { kode: '', judul: '', kategori: '', upbjj: '', harga: 0, qty: 0, safety: 10, cover: 'assets/img/std_buku.jpg'};
        ...
        handleSimpanStok(formData) {
             if (this.modeModal === 'tambah') {
                ...
                if(exists) { alert("Kode buku sudah ada!"); return; }
                ...
                if (index !== -1) {
                    Vue.set(this.state.stok, index, formData);
        ...
        handleSimpanDO(formData) {
            ...
            const dataBaru = {
                ...
                perjalanan: [
                    { waktu: new Date().toLocaleString('id-ID'), keterangan: 'Order DO dibuat.' }
                ]
            };

            Vue.set(this.state.tracking, nomorBaru, dataBaru);
