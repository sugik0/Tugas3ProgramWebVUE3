        ...
        <nav class="main-header-nav">
            ...
            <div class="nav-center">
                <ul class="nav-menu" v-if="isLoggedIn">
                    <li>
                        <a href="#" @click.prevent="gantiTab('stok')"
                           :class="{ active: currentTab === 'stok' }">Informasi Bahan Ajar</a>
                    </li>
                    <li>
                        <a href="#" @click.prevent="gantiTab('tracking')"
                           :class="{ active: currentTab === 'tracking' }">Tracking Pengiriman</a>
                    </li>
                    <li>
                        <a href="#" @click.prevent="gantiTab('order')"
                           :class="{ active: currentTab === 'order' }">Pemesanan</a>
                    </li>
                    <li class="dropdown">
